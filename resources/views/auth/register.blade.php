...
<head>
    ...
    <title>Registreren - POS Systeem</title>
    ...
    <div class="w-full max-w-5xl bg-white md:rounded-3xl shadow-2xl overflow-hidden grid grid-cols-1 md:grid-cols-2">
        ...
        <div class="flex flex-col justify-center w-full md:p-10">
            <div class="w-full md:max-w-md mx-auto p-6 md:p-0">
                <h2 class="text-2xl md:text-3xl font-bold text-gray-800 mb-6 text-center">Registreren</h2>

                <form method="POST" action="{{ route('register') }}" class="space-y-5">
                    @csrf

                    <div>
                        <label class="block mb-1 text-gray-600">Naam</label>
                    ...
                    <div>
                        <label class="block mb-1 text-gray-600">Bevestig wachtwoord</label>
                    ...
                    <p class="text-center text-gray-600 text-sm">
                        Al een account?
                        <a href="{{ route('login') }}" class="text-indigo-600 font-semibold hover:underline">Inloggen</a>
                    </p>
                </form>
            </div>
        </div>
