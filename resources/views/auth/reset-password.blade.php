...
<head>
    ...
    <title>Wachtwoord Resetten - POS Systeem</title>
    ...
    <div class="w-full max-w-5xl bg-white md:rounded-3xl shadow-2xl overflow-hidden grid grid-cols-1 md:grid-cols-2">
        ...
        <div class="flex flex-col justify-center w-full md:p-10">
            <div class="w-full md:max-w-md mx-auto p-6 md:p-0">
                <h2 class="text-2xl md:text-3xl font-bold text-gray-800 mb-6 text-center">Wachtwoord Resetten</h2>
                ...
                <form method="POST" action="{{ route('password.store') }}" class="space-y-5">
                    ...
                    <!-- Password -->
                    <div>
                        <label class="block mb-1 text-gray-600">Nieuw wachtwoord</label>
